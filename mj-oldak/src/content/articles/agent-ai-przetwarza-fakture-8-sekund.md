...
Jeśli chcesz zobaczyć pipeline w akcji na **Twojej własnej fakturze** (zanonimizowana, nic nie zostaje w mojej bazie) — [napisz na biuro@mjoldak.pl](/#kontakt). 20-minutowe demo, pokazuję live każdy krok: Azure DI raw response, Claude classification, NIP validation, final insert do mockowego Comarcha.
