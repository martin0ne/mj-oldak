---
title: "Dlaczego pierwsze demo AI pokazałem za darmo — strategia sprzedaży dla solo-founderów"
excerpt: "Pierwszy klient nie zapłacił mi złotówki. I to była najlepsza decyzja sprzedażowa, jaką podjąłem w MJ.OLDAK SYSTEMS. Dlaczego — z liczbami i psychologią kupującego."
publishedAt: 2026-05-13
author: "Marcin Ołdak"
category: "case-study"
tags: ["automatyzacja", "biuro-rachunkowe", "case-study"]
cover: "/articles/covers/dlaczego-pierwsze-demo-pokazalem-za-darmo.jpg"
...
Jared Friedman i Gustaf Alströmer z Y Combinator mają [słynny sales playbook](https://www.ycombinator.com/library/Mo-the-sales-playbook-for-founders) z jednym brutalnie prostym zdaniem od Tom Blomfielda: "If they don't pay, they're not a customer".

Zgadzam się. W USA, dla SaaS-a, w kategorii, którą kupujący rozumie z automatu.

Problem: polski rynek automatyzacji AI dla MŚP jest na etapie, którego USA nie ma od 2023 roku. [Raport PARP 2026](https://www.parp.gov.pl/component/content/article/90199:cyfryzacja-polskich-firm-widoczny-postep-ale-wiele-obszarow-wciaz-wymaga-poprawy) pokazuje jasno: 94,1% polskich firm nie korzysta z AI. W małych firmach — ledwo 3,93%. Luka wobec UE to 7,58 punktu procentowego i ona **rośnie**, nie maleje.
...
Jest jednak jeden warunek, który podkreśla [AWA Digital w analizie CRO](https://www.awa-digital.com/blog/psychological-principles-in-cro/): reciprocity działa tylko, kiedy wartość jest autentyczna. "False generosity intended only to engineer obligation damages credibility". Jeśli twoje demo jest pokazówką z mock-danymi — efekt się nie pojawia. Jeśli działa na realnej fakturze klienta — mózg reaguje inaczej.
...
Dla kontekstu: średni cold email ma [0,1% meeting rate](https://buska.io), spersonalizowany LinkedIn outreach 3–4%, a konwersja z B2B live demo — kiedy dotarłeś do sali — jest wyższa niż z typowego opt-in free trial (17–18% według [SaasFactor 2026](https://www.saasfactor.co/blogs/freemium-vs-trial-models-in-saas-what-really-boosts-conversions)), bo nie ma frictionu onboardingu. Jesteś tam razem z klientem.
...
Liczby z [raportu AI Chamber 2024](https://aichamber.eu/report/raport-ai-chamber-2024-rola-ai-w-msp/) (N=350 firm):
...
- [Puls Biznesu 2026](https://www.pb.pl/sztuczna-inteligencja-w-msp-mniej-entuzjazmu-wiecej-kalkulacji-1258533) + PIE IX 2025: 77% firm niekorzystających z AI nie chce wdrażać, dopóki nie muszą
...
W rynku, gdzie [94% firm nie zna produktu](https://biznes.newseria.pl/news/polskie-firmy-z-sektora,p99224929), darmowe demo to nie rabat. To koszt edukacji, który i tak trzeba ponieść — różnica polega tylko na tym, czy poniesiesz go w formie content marketingu (wolno i skalowalnie), czy w formie 1-na-1 demo (szybko i z konwersją).
...
W praktyce najlepiej działa C — bo zachowuje percepcję wartości, a [SPP.co ma rację](https://spp.co), że "price communicates quality before you've delivered anything".
...
[Startup Strategies](https://startupstrategies.substack.com/p/pilots-should-they-be-free-or-paid) piszą to prosto: "Free pilots tend to result in less honest feedback". Klient, który nie zapłacił, ma psychologicznie niższy próg rezygnacji. Nie powie ci, co jest nie tak — po prostu przestanie odpowiadać na maile.

Adam Robinson i [RB2B zrobili darmową wersję](https://www.youtube.com/watch?v=fdE2N2ckDSw), która w 6 tygodni przyniosła 1M ARR, ale to działało, bo: (a) produkt miał wbudowany efekt wirusowy, (b) każde demo było qualified leadem, (c) przejście do paid tier było technicznie jednym kliknięciem. Solo-founder budujący custom agentów dla biur rachunkowych nie ma żadnego z tych warunków.
...
**Ryzyko 2 — pozycjonowanie jako "tanie".** [SPP.co ma na to dobry slogan](https://spp.co): cena komunikuje jakość, zanim cokolwiek dostarczysz. Mitygacja w moim wypadku: zawsze podaję standardową cenę na początku rozmowy, a dopiero potem mówię, że za pierwsze case studies robię za darmo.
...
Jeśli prowadzisz biuro rachunkowe albo MŚP, które ma dużo powtarzalnej pracy na fakturach, mailach albo deadlineach — [napisz na biuro@mjoldak.pl](/#kontakt). Pokażę demo na twoich realnych danych (zanonimizowanych), bezpłatnie. Jak widzisz wyżej — wciąż mam jeszcze kilka slotów w pipeline case studies.
