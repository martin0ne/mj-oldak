---
title: "AI Act 2026 — co polskie MŚP musi wdrożyć i jak to się ma do RODO"
excerpt: "2 sierpnia 2026 wchodzą pełne obowiązki transparentności i high-risk z AI Act. Praktyczny przewodnik dla biur rachunkowych i małych firm — bez prawniczego bełkotu."
publishedAt: 2026-05-09
author: "Marcin Ołdak"
category: "edukacja"
tags: ["ai-act", "compliance", "biuro-rachunkowe"]
cover: "/articles/covers/ai-act-co-polskie-msp-musi-wiedziec.jpg"
...
**Od sierpnia 2025** — działają organy nadzorcze i kary. Polska procedura wdrożeniowa trwa (Ministerstwo Cyfryzacji proponuje Komisję Rozwoju i Bezpieczeństwa SI — monitoruj [gov.pl/web/cyfryzacja/wdrozenie-aktu-o-ai](https://www.gov.pl/web/cyfryzacja/wdrozenie-aktu-o-ai)).
...
1. Umieści swoją nazwę/znak towarowy na systemie high-risk już wprowadzonym na rynek
2. Istotnie zmodyfikuje system high-risk
3. Zmieni przeznaczenie systemu tak, że staje się high-risk
...
1. Czy interes jest legalny?
2. Czy przetwarzanie jest **niezbędne** dla tego interesu?
3. Czy prawa osoby nie przeważają nad interesem administratora?
...
1. **Banner przed pierwszą wiadomością:** "Rozmawiasz z asystentem AI. Odpowiedzi generowane automatycznie na podstawie bazy FAQ. W sprawach indywidualnych — [kontakt z człowiekiem]".
2. **Oznaczenie wizualne** (ikona bota, inny kolor) w interfejsie.
3. **Link do polityki AI** w stopce.
...
Jeśli budujesz własny stack i chcesz zobaczyć, jak wygląda pipeline z human-in-the-loop w praktyce — opisałem to w osobnym tekście: [Stack pod agentów AI: Claude, n8n, Azure Document Intelligence](/artykuly/stack-pod-agentow-ai-claude-n8n-azure/).
...
1. **Wysyłka danych do API AI = powierzenie** w rozumieniu RODO. Wymaga umowy DPA (Data Processing Agreement) z dostawcą + standardowe klauzule umowne (SCC) jeśli dane lecą do USA.
2. **Shadow AI pracowników = niedopuszczalne.** Księgowa wrzucająca faktury do prywatnego ChatGPT bez DPA to naruszenie umowy z klientem i RODO.
3. **Umowa z dostawcą AI musi wykluczać trening na danych klientów.** Anthropic (Claude API) ma to w domyślnym kontrakcie — OpenAI w API też, ale warto zweryfikować plan i checkboxy.
...
1. **Inwentaryzacja wszystkich systemów AI** używanych w firmie — w tym shadow AI (prywatne konta ChatGPT pracowników, narzędzia z rozszerzeń przeglądarki, wbudowane funkcje AI w Microsoft 365, Google Workspace).
2. **Klasyfikacja ryzyka** każdego systemu — zakazany / high-risk / limited / minimal.
3. **DPA z dostawcami AI** (Anthropic, OpenAI, Microsoft, Google). Jeśli nie masz — podpisz przed pierwszym użyciem na danych klienta.
4. **Aktualizacja klauzul informacyjnych RODO** u klientów — dopisz informację, że używasz AI do przetwarzania dokumentów, z jakim celem i z kim dzielisz dane.
5. **Ocena art. 6(3)** dla systemów granicznych — dokument wewnętrzny uzasadniający, że Twój system nie jest high-risk.
6. **Wdrożenie transparentności art. 50** — chatbot, voicebot, oznaczenia e-maili generowanych.
7. **Szkolenie AI literacy** dla pracowników — obowiązek od 2.02.2025. Zapisana lista obecności, agenda, podpisy.
8. **Polityka używania AI** w firmie — pisemny dokument: co wolno, czego nie wolno, gdzie zgłaszać problemy.
9. **DPIA** dla systemów przetwarzających dane w dużej skali.
10. **Monitoring legislacyjny** — śledź Digital Omnibus i polską ustawę wdrożeniową. Kalendarz z datami kluczowymi.

Jeśli dopiero zastanawiasz się nad zakupem automatyzacji AI i chcesz zadać właściwe pytania dostawcy — polecam [5 pytań przed zakupem automatyzacji AI](/artykuly/5-pytan-przed-zakupem-automatyzacji-ai/).
...
**Nie wiadomo na pewno.** Ministerstwo Cyfryzacji pracuje nad projektem. Termin powołania polskiego organu (Komisji Rozwoju i Bezpieczeństwa SI) minął 2.08.2025. Monitoruj [gov.pl/web/cyfryzacja/wdrozenie-aktu-o-ai](https://www.gov.pl/web/cyfryzacja/wdrozenie-aktu-o-ai) — tam publikowane są konsultacje i projekty.

## Źródła i dalsza lektura

- [EUR-Lex — pełen tekst AI Act (Rozporządzenie 2024/1689)](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689)
- [AI Act Service Desk — Timeline](https://ai-act-service-desk.ec.europa.eu/en/ai-act/timeline/timeline-implementation-eu-ai-act)
- [Art. 50 — Transparency obligations](https://artificialintelligenceact.eu/article/50/)
- [Art. 99 — Penalties](https://artificialintelligenceact.eu/article/99/)
- [Art. 26 — Obligations of deployers](https://artificialintelligenceact.eu/article/26/)
- [Small Business Guide to the AI Act](https://artificialintelligenceact.eu/small-businesses-guide-to-the-ai-act/)
- [Ministerstwo Cyfryzacji — wdrożenie AI Act](https://www.gov.pl/web/cyfryzacja/wdrozenie-aktu-o-ai)
- [UODO — stanowisko ws. AI i RODO](https://uodo.gov.pl/pl/589/3224)
- [EDPB — Opinion on AI Models and GDPR (18.12.2024)](https://www.edpb.europa.eu/news/news/2024/edpb-opinion-ai-models-gdpr-principles-support-responsible-ai_en)

## Następne kroki

Jeśli masz czucie, że Twoje biuro jest "gdzieś w szarej strefie" i nie wiesz, czy używany OCR to high-risk czy nie — napisz. W 30 minut bezpłatnej konsultacji zmapujemy Twoje systemy, sklasyfikujemy ryzyko i wskażemy 3 najpilniejsze kroki. [Kontakt: biuro@mjoldak.pl](/#kontakt).
